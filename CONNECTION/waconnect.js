...
function serialize(msg, dsan) {
    if (msg.key) {
        ...
        msg.sender = msg.isGroup ? decodeJid(msg.key.participant) : msg.isSelf ? decodeJid(dsan.user.id) : msg.from
    }
    if (msg.message) {
        ...
        try {
            ...
            msg.quoted.isSelf = msg.quoted.participant === decodeJid(dsan.user.id)
